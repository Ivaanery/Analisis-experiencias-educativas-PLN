...
model.add(Dense(64, activation='relu'))  # Otra capa oculta con 64 neuronas
model.add(Dense(1, activation='sigmoid'))  # Capa de salida (sigmoid para clasificación binaria)
